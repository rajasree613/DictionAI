...
#search function
def search():
    data=json.load(open('BengaliDictionary.json', encoding='utf-8-sig'))
...
#Entryword
entrywordlabel = Label(q,text='Enter Word',bg='#333333',fg='crimson',font=('Times New Roman',25,'bold'))
...
#Textbox
textarea=Text(q, width=38, height=4.5, font=('Siyam Rupali', 18), bd=2, relief=GROOVE)
